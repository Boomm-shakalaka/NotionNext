...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    //https://music.163.com/，网易音乐，找到能放的歌，然后复制顶部id（https://music.163.com/#/song?id=461544130）。图片通过右键检查封面，提取https://p2.music.126.net/
    {
      name: 'feelslikeimfallinginlove',
      artist: 'coldplay',
      url: 'https://music.163.com/song/media/outer/url?id=2600347798.mp3',
      cover:
        'https://p2.music.126.net/KAnddmAzTlA0upNhVL_6rA==/109951169702118601.jpg'
    },
    {
      name: 'Hymn For the Weekend',
      artist: 'coldplay',
      url: 'https://music.163.com/song/media/outer/url?id=461544130.mp3',
      cover:
        'https://p1.music.126.net/1Cg_SfvPnVLJm5_6JDdbzg==/18633423557738147.jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '12937783580', // 对应歌单的 id
